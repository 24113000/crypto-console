...
public class BuyInfoCommand implements Command {
    ...
    public BuyInfoCommand(String raw, String exchange, String baseAsset, BigDecimal quoteAmount, String quoteAsset) {
        this.raw = raw;
